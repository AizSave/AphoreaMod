...
public class RuneInventorHouse extends Preset {
        ...
        this.addCustomApply(0, 7, 2, (level, levelX, levelY, dir, blackboard) -> {
            try {
                ...
                if (objEnt instanceof SignObjectEntity) {
                    String name = HumanMob.getRandomName(random, random.getOneOf(new String[]{"Aritz"}, HumanMob.maleNames, HumanMob.femaleNames, HumanMob.neutralNames, HumanMob.elderNames));
