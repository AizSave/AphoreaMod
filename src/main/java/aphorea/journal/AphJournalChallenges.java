...
public class AphJournalChallenges {
    ...
    public static void registerCore() {
        ...
        APH_FOREST_SURFACE_CHALLENGES_ID = registerChallenge("aphoreaswampsurface", (new MultiJournalChallenge(KILL_PINK_WITCHES_ID)).setReward(APH_SWAMP_SURFACE_REWARD));
