...
public class AphDistances {
    ...
    static public Mob findClosestMob(Mob mob, int distance, Predicate<Mob> filter) {
    ...
    static public Mob findClosestMob(Level level, float x, float y, int distance, Predicate<Mob> filter) {
