...
public class AphCustomChargeAttackHandler<T extends AphChargeAttackToolItem> extends MouseAngleAttackHandler {
    public T toolItem;
    public InventoryItem item;
    public int seed;
    public long startTime;
    public AphCustomChargeLevel<T>[] chargeLevels;
    ...
    public AphCustomChargeAttackHandler(PlayerMob player, PlayerInventorySlot slot, InventoryItem item, T toolItem, int seed, int startX, int startY, AphCustomChargeLevel<T>[] chargeLevels) {
    ...
    public void updateCurrentChargeLevel() {
        while (true) {
            if (this.currentChargeLevel < this.chargeLevels.length - 1) {
                ...
                AphCustomChargeLevel<T> nextLevel = this.chargeLevels[this.currentChargeLevel + 1];
    ...
    public void onEndAttack(boolean bySelf) {
        ...
        if (this.currentChargeLevel >= 0 && !this.endedByInteract) {
            ...
            AphCustomChargeLevel<T> currentLevel = this.chargeLevels[this.currentChargeLevel];
            ...
            toolItem.endChargeAttack(item, player, dir, this.currentChargeLevel);
