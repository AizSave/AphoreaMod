...
public class RapierDashLevelEvent extends MobDashLevelEvent {
    public RapierDashLevelEvent() {
    }

    public RapierDashLevelEvent(Mob owner, int seed, float dirX, float dirY, float distance, int animTime, GameDamage damage) {
